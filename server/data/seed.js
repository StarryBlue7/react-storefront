...
var _a = require("../models"), User = _a.User, Product = _a.Product, Category = _a.Category, Tag = _a.Tag, Order = _a.Order;
...
connection.once("open", function () { return __awaiter(_this, void 0, void 0, function () {
    var allCategories, categories, categoryIds, tags, tagIds, referProducts, products;
    var _this = this;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                ...
                allCategories.forEach(function (category) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        switch (_a.label) {
                            case 0:
                                ...
                                subCategories = category.subCategories
                                    ...
                                    : null;
                                return [4 /*yield*/, Category.updateOne({ name: category.name }, { parentCategory: parentCategory, subCategories: subCategories })];
